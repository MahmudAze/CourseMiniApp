    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            MainInput:
                ...
                {
                    Helper.ColorWrite(ConsoleColor.Red, "Input type is incorrect! Please enter a number.");
                    goto MainInput;
                }
                ...
                switch (mainChoice)
                {
                    ...
                    case 0:
                        ...
                        return;
                    default:
                        Helper.ColorWrite(ConsoleColor.Red, "Incorrect menu choice!");
                        goto MainInput;
                }
            }
        }
        ...
        static void CourseGroupMenu(CourseGroupService groupService)
        {
            ...
            Input:
                ...
                {
                    Helper.ColorWrite(ConsoleColor.Red, "Input type is incorrect!");
                    goto Input;
                }
                switch (choice)
                {
        ...
        static void StudentMenu(StudentService studentService, CourseGroupService groupService)
        {
            while (true)
            {
                ...
                {
                    Helper.ColorWrite(ConsoleColor.Red, "Incorrect input!");
                    continue;
                }
